      ...
      <Actionsheet isOpen={currentIndex || !index ? openActionSheet : false} onClose={onClose}>
        <Actionsheet.Content>
          <TouchableOpacity onPress={() => setOpenActionSheet(false)} style={{ top: 30, position: "absolute" }}>
            <Text style={{ fontFamily: "JetBrainsMono-ExtraBoldItalic", color: "#000" }}>Tap To Close</Text>
          </TouchableOpacity>
          <View style={{ height: 400, width: "105%", justifyContent: "center", alignItems: "center" }}>
            <Text style={{ textAlign: "center", margin: 20, fontFamily: "JetBrainsMono-ExtraBoldItalic", fontSize: 17, color: "#808080" }}>{item.title}</Text>
            <Text style={{ textAlign: "center", margin: 20, fontFamily: "JetBrainsMono-ExtraBoldItalic", fontSize: 12, color: "#909090" }}>{item.description}</Text>
